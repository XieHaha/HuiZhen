 ...
 * @des 待处理转诊订单
 */
public class TransferWaitAdapter extends BaseQuickAdapter<TransferDetailBean, BaseViewHolder> {
    public TransferWaitAdapter(int layoutResId, @Nullable List<TransferDetailBean> data) {
