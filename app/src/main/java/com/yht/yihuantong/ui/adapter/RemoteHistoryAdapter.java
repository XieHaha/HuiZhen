 ...
 * @des 远程会诊记录
 */
public class RemoteHistoryAdapter extends BaseQuickAdapter<RemoteBean, BaseViewHolder> implements CheckOrderStatus {
    ...
    protected void convert(BaseViewHolder helper, RemoteBean item) {
        ...
        helper.setText(R.id.tv_check_name, item.getPatientName()).addOnClickListener(R.id.iv_check_img);
