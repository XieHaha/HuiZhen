 ...
 * @des 远程会诊记录
 */
public class RemoteHistoryAdapter extends BaseQuickAdapter<CheckBean, BaseViewHolder> implements CheckOrderStatus {
    public RemoteHistoryAdapter(int layoutResId, @Nullable List<CheckBean> data) {
