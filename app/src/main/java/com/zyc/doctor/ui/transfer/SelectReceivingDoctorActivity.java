...
import com.zyc.doctor.ui.adapter.DoctorAdapter;
...
public class SelectReceivingDoctorActivity extends BaseActivity
    ...
    private List<String> hospitals, departOne, departTwo;
    ...
    public void initData(@NonNull Bundle savedInstanceState) {
        ...
        departOneAdapter = new DepartOneAdapter(R.layout.item_depart, hospitals);
     ...
     * 一级科室数据处理
     */
    private void initDepartOne(String hospital) {
