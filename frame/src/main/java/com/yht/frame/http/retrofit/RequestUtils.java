...
public class RequestUtils {
    public static void weChatLogin(Context context, String code, String merchant,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(new AbstractLoadViewObserver<>(context, true, Tasks.WE_CHAT_LOGIN,
                        listener));
    }

    public static void weChatBind(Context context, String openid, String unionid, String phone,
                                  String prepareId,
        ...
        RetrofitManager.getApiUrlManager()
                .weChatBind(params)
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true, Tasks.WE_CHAT_BIND,
                        listener));
    }
    ...
    public static void updateIntroduce(Context context, String token, String introduce,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(
                        new AbstractLoadViewObserver<>(context, true, false,
                                Tasks.UPDATE_INTRODUCE, listener));
    }

    public static void getProtocolUpdateDate(Context context,
                                             final ResponseListener<BaseResponse> listener) {
        RetrofitManager.getApiUrlManager()
                .getProtocolUpdateDate()
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(
                        new AbstractLoadViewObserver<>(context, true,
                                Tasks.GET_PROTOCOL_UPDATE_DATE, listener));
    }
    ...
    public static void uploadImg(Context context, String token, File file,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true, Tasks.UPLOAD_FILE,
                        listener));
    }
    ...
    public static void getAppMessageList(Context context, String token, int pageSize, int startPage,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, Tasks.GET_APP_MESSAGE_LIST,
                        listener));
    }
    ...
    public static void getAppUnReadMessageTotal(Context context, String token,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(
                        new AbstractLoadViewObserver<>(context,
                                Tasks.GET_APP_UNREAD_MESSAGE_TOTAL, listener));
    }
    ...
    public static void updateAppUnReadMessageAll(Context context, String token,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(
                        new AbstractLoadViewObserver<>(context,
                                Tasks.UPDATE_APP_UNREAD_MESSAGE_ALL, listener));
    }
    ...
    public static void updateAppUnReadMessageById(Context context, String token, int id,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(new AbstractLoadViewObserver<>(context,
                        Tasks.UPDATE_APP_UNREAD_MESSAGE_BY_ID,
                        listener));
    }
    ...
    public static void updateAppUnReadMessageByNotify(Context context, String token, String id,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context,
                        Tasks.UPDATE_APP_UNREAD_MESSAGE_BY_NOTIFY,
                        listener));
    }
    ...
    public static void getHospitalListByAuth(Context context, String token,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_HOSPITAL_LIST_BY_AUTH,
                        listener));
    }
    ...
    public static void getHospitalListByReverse(Context context, String token,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_HOSPITAL_LIST_BY_RESERVE,
                        listener));
    }
    ...
    public static void getHospitalListByTransferOther(Context context, String token, String orderNo,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(
                        new AbstractLoadViewObserver<>(context, true,
                                Tasks.GET_HOSPITAL_LIST_BY_TRANSFER_OTHER,
                                listener));
    }
    ...
    public static void getHospitalListByReceive(Context context, String token,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_HOSPITAL_LIST_BY_RECEIVE,
                        listener));
    }
    ...
    public static void getDepartOneListByReverse(Context context, String token, String hospitalCode,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(
                        new AbstractLoadViewObserver<>(context,
                                Tasks.GET_DEPART_ONE_LIST_BY_REVERSE, listener));
    }

    public static void getDepartTwoListByReverse(Context context, String token,
                                                 String hospitalCode, int pid,
                                                 final ResponseListener<BaseResponse> listener) {
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(
                        new AbstractLoadViewObserver<>(context,
                                Tasks.GET_DEPART_TWO_LIST_BY_REVERSE, listener));
    }

    public static void getDoctorListByReverse(Context context, String token,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context,
                        Tasks.GET_DOCTOR_LIST_BY_REVERSE, listener));
    }

    public static void getReceivingDoctorList(Context context, String token,
                                              Map<String, Object> params,
                                              final ResponseListener<BaseResponse> listener) {
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context,
                        Tasks.GET_RECEIVING_DOCTOR_LIST, listener));
    }
    ...
    public static void getDepartTree(Context context, String hospitalCode, String token,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true, Tasks.GET_DEPART_LIST,
                        listener));
    }

    public static void submitDoctorAuth(Context context, DoctorAuthBean bean, String token,
                                        String phone,
                                        String merchant,
                                        final ResponseListener<BaseResponse> listener) {
    ...
    public static void getDoctorInfo(Context context, String token, String phone,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true, Tasks.GET_DOCTOR_INFO,
                        listener));
    }
    ...
    public static void getDoctorAuth(Context context, String token, String phone,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true, Tasks.GET_DOCTOR_AUTH,
                        listener));
    }
    ...
    public static void getDataByType(Context context, String token, String type,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true, Tasks.DATA_JOB_TITLE,
                        listener));
    }
    ...
    public static void getDoctorInfoAndBalanceInfo(Context context, String token,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_DOCTOR_INFO_AND_BALANCE_INFO,
                        listener));
    }
    ...
    public static void getDoctorIncomeDetail(Context context, int doctorOrderTranId, String token,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(
                        new AbstractLoadViewObserver<>(context, true,
                                Tasks.GET_DOCTOR_INCOME_DETAIL, listener));
    }
    ...
    public static void getDoctorWithdraw(Context context, int doctorOrderTranId, String token,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_DOCTOR_WITHDRAW, listener));
    }
    ...
    public static void getDoctorWithdrawByMonth(Context context, String queryMonth, String token,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_DOCTOR_WITHDRAW_BY_MONTH,
                        listener));
    }

    public static void getDoctorIncomeList(Context context, String token, int pageSize,
                                           int startPage,
                                           final ResponseListener<BaseResponse> listener) {
        Map<String, Integer> params = new HashMap<>(16);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(
                        new AbstractLoadViewObserver<>(context, true,
                                Tasks.GET_DOCTOR_INCOME_LIST, listener));
    }

    public static void getDoctorIncomeWithOutList(Context context, String token, int pageSize,
                                                  int startPage,
                                                  final ResponseListener<BaseResponse> listener) {
        Map<String, Object> params = new HashMap<>(16);
        params.put("start_page", startPage);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_DOCTOR_INCOME_WITHOUT_LIST,
                        listener));
    }

    public static void getDoctorIncomeByMonthList(Context context, String token, int queryMonth,
                                                  int pageSize,
                                                  int startPage,
                                                  final ResponseListener<BaseResponse> listener) {
        Map<String, Integer> params = new HashMap<>(16);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_DOCTOR_INCOME_BY_MONTH_LIST,
                        listener));
    }
    ...
    public static void getPatientListByDoctorCode(Context context, String code, String token,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context,
                        Tasks.GET_PATIENT_LIST_BY_DOCTOR_CODE,
                        listener));
    }
    ...
    public static void getDoctorListByDoctorCode(Context context, String token,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, Tasks.GET_DOCTOR_LIST,
                        listener));
    }
    ...
    public static void getPatientDetailByPatientCode(Context context, String code, String token,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context,
                        Tasks.GET_PATIENT_DETAIL_BY_PATIENT_CODE,
                        listener));
    }

    public static void getPatientOrderListByPatientCode(Context context, String patientCode,
                                                        String token, int pageSize,
                                                        int startPage, boolean showLoadView,
                                                        final ResponseListener<BaseResponse> listener) {
        Map<String, Object> params = new HashMap<>(16);
    ...
    public static void verifyPatient(Context context, String token, String idCard,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true, Tasks.VERIFY_PATIENT,
                        listener));
    }
    ...
    public static void getPatientExistTransfer(Context context, String token, String patientCode,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_PATIENT_EXIST_TRANSFER,
                        listener));
    }
    ...
    public static void addReserveCheckOrder(Context context, String token, ReserveCheckBean bean,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true, false,
                        Tasks.ADD_RESERVE_CHECK_ORDER,
                        listener));
    }

    public static void getReserveCheckOrderList(Context context, String token, int pageSize,
                                                int startPage,
                                                boolean showLoading,
                                                final ResponseListener<BaseResponse> listener) {
        Map<String, Integer> params = new HashMap<>(16);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(
                        new AbstractLoadViewObserver<>(context, showLoading,
                                Tasks.GET_RESERVE_CHECK_ORDER_LIST,
                                listener));
    }
    ...
    public static void getReserveCheckOrderDetail(Context context, String token, String orderNo,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_RESERVE_CHECK_ORDER_DETAIL,
                        listener));
    }
    ...
    public static void getCheckTypeByHospitalList(Context context, String token,
                                                  String hospitalCode,
                                                  String projectName, String selectCodes,
                                                  int page,
                                                  final ResponseListener<BaseResponse> listener) {
        Map<String, Object> params = new HashMap<>(16);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_CHECK_TYPE_BY_HOSPITAL,
                        listener));
    }

    public static void addReserveTransferOrder(Context context, String token,
                                               ReserveTransferBean bean,
                                               final ResponseListener<BaseResponse> listener) {
        Map<String, Object> params = new HashMap<>(16);
        params.put("allergyHistory", bean.getAllergyHistory());
        params.put("confirmPhoto", bean.getConfirmPhoto());
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true, false,
                        Tasks.ADD_RESERVE_TRANSFER_ORDER,
                        listener));
    }

    public static void cancelReserveTransferOrder(Context context, String token,
                                                  String cancelReason, String orderNo,
                                                  final ResponseListener<BaseResponse> listener) {
        Map<String, String> params = new HashMap<>(16);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(
                        new AbstractLoadViewObserver<>(context, true, false,
                                Tasks.CANCEL_RESERVE_TRANSFER_ORDER,
                                listener));
    }

    public static void receiveReserveTransferOrder(Context context, String token,
                                                   String receiveHospitalCode,
                                                   String orderNo, String appointAt, String note,
                                                   final ResponseListener<BaseResponse> listener) {
        Map<String, String> params = new HashMap<>(16);
    ...
    public static void updateReserveTransferOrder(Context context, String token,
                                                  String receiveHospitalCode,
                                                  String orderNo, String appointAt, String note,
                                                  final ResponseListener<BaseResponse> listener) {
        Map<String, String> params = new HashMap<>(16);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(
                        new AbstractLoadViewObserver<>(context, true, false,
                                Tasks.UPDATE_RESERVE_TRANSFER_ORDER,
                                listener));
    }

    public static void rejectReserveTransferOrder(Context context, String token,
                                                  String rejectReason, String orderNo,
                                                  final ResponseListener<BaseResponse> listener) {
        Map<String, String> params = new HashMap<>(16);
        params.put("orderNo", orderNo);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(
                        new AbstractLoadViewObserver<>(context, true, false,
                                Tasks.REJECT_RESERVE_TRANSFER_ORDER,
                                listener));
    }

    public static void transferAgainOtherDoctor(Context context, String token, String orderNo,
                                                String targetDoctorCode,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(
                        new AbstractLoadViewObserver<>(context, true, false,
                                Tasks.TRANSFER_AGAIN_OTHER_DOCTOR,
                                listener));
    }

    public static void getInitiateTransferOrderList(Context context, String token, int pageSize,
                                                    int startPage,
                                                    boolean showLoading,
                                                    final ResponseListener<BaseResponse> listener) {
        Map<String, Integer> params = new HashMap<>(16);
    ...
    public static void getTransferStatusOrderList(Context context, String token,
                                                  int receiveStatus, int pageSize,
                                                  int startPage,
                                                  final ResponseListener<BaseResponse> listener) {
        Map<String, Integer> params = new HashMap<>(16);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(
                        new AbstractLoadViewObserver<>(context,
                                Tasks.GET_TRANSFER_STATUS_ORDER_LIST, listener));
    }
    ...
    public static void getTransferOrderDetail(Context context, String token, String orderNo,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_TRANSFER_ORDER_DETAIL,
                        listener));
    }
    ...
    public static void getStudioOrderStatistics(Context context, String token,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context,
                        Tasks.GET_STUDIO_ORDER_STATISTICS, listener));
    }

    public static void getBanner(Context context, String token,
                                 final ResponseListener<BaseResponse> listener) {
        RetrofitManager.getApiUrlManager()
                .getBanner(token)
                .compose(RxJavaHelper.observableIO2Main(context))
    ...
    public static void startChat(Context context, String token, String doctorCode,
                                 String patientCode,
                                 final ResponseListener<BaseResponse> listener) {
        Map<String, String> params = new HashMap<>(16);
    ...
    public static void getChatLastTime(Context context, String token, String doctorCode,
                                       String patientCode,
                                       final ResponseListener<BaseResponse> listener) {
        Map<String, String> params = new HashMap<>(16);
        params.put("doctorCode", doctorCode);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, Tasks.GET_CHAT_LAST_TIME,
                        listener));
    }
    ...
    public static void getCooperateHospitalList(Context context, String token, int pageSize,
                                                int startPage,
                                                boolean show,
                                                final ResponseListener<BaseResponse> listener) {
        Map<String, Integer> params = new HashMap<>(16);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, show,
                        Tasks.GET_COOPERATE_HOSPITAL_LIST,
                        listener));
    }

    public static void getCooperateHospitalDetail(Context context, String token,
                                                  String hospitalCode,
                                                  final ResponseListener<BaseResponse> listener) {
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_COOPERATE_HOSPITAL_DETAIL,
                        listener));
    }

    public static void getCooperateHospitalProjectList(Context context, String token,
                                                       String hospitalCode,
                                                       final ResponseListener<BaseResponse> listener) {
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context,
                        Tasks.GET_COOPERATE_HOSPITAL_PROJECT_LIST,
                        listener));
    }

    public static void getCooperateHospitalPackageList(Context context, String token,
                                                       String hospitalCode, int pageSize,
                                                       int startPage,
                                                       final ResponseListener<BaseResponse> listener) {
        Map<String, Object> params = new HashMap<>(16);
        params.put("hospitalCode", hospitalCode);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(
                        new AbstractLoadViewObserver<>(context, true,
                                Tasks.GET_COOPERATE_HOSPITAL_PACKAGE_LIST,
                                listener));
    }

    public static void getCooperateHospitalServiceList(Context context, String token,
                                                       String hospitalCode, int pageSize,
                                                       int startPage,
                                                       final ResponseListener<BaseResponse> listener) {
        Map<String, Object> params = new HashMap<>(16);
    ...
    public static void queryProductDetail(Context context, String token, String productCode,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context,
                        Tasks.GET_COOPERATE_HOSPITAL_PROJECT_DETAIL,
                        listener));
    }

    public static void getDoctorQrCode(Context context, String token,
                                       final ResponseListener<BaseResponse> listener) {
        RetrofitManager.getApiUrlManager()
                .getDoctorQrCode(token)
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, Tasks.GET_DOCTOR_QR_CODE,
                        listener));
    }
    ...
    public static void getLabel(Context context, String token, String patientCode,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true, Tasks.GET_LABEL,
                        listener));
    }

    public static void savePatientLabel(Context context, String token, String patientCode,
                                        List<String> tagList,
                                        final ResponseListener<BaseResponse> listener) {
        Map<String, Object> params = new HashMap<>(16);
        params.put("patientCode", patientCode);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true, false,
                        Tasks.SAVE_PATIENT_LABEL,
                        listener));
    }

    public static void getPatientLabel(Context context, String token, int pageSize, int startPage
            , boolean showLoading,
                                       final ResponseListener<BaseResponse> listener) {
        Map<String, Integer> params = new HashMap<>(16);
        params.put("pageSize", pageSize);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(
                        new AbstractLoadViewObserver<>(context, showLoading,
                                Tasks.GET_PATIENT_LABEL, listener));
    }
    ...
    public static void deleteLabel(Context context, String token, long tagId,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, Tasks.DELETE_PATIENT_LABEL,
                        listener));
    }

    public static void getExistLabel(Context context, String token,
                                     final ResponseListener<BaseResponse> listener) {
        RetrofitManager.getApiUrlManager()
                .getExistLabel(token)
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, Tasks.GET_EXIST_LABEL,
                        listener));
    }
    ...
    public static void getPatientByLabel(Context context, String token, long tagId,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_PATIENT_BY_LABEL, listener));
    }
    ...
    public static void getRemoteDetail(Context context, String token, String orderNo,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true, Tasks.GET_REMOTE_DETAIL,
                        listener));
    }

    public static void getPatientByQrId(Context context, String token, String patientId,
                                        int createRelation,
                                        final ResponseListener<BaseResponse> listener) {
        Map<String, Object> params = new HashMap<>(16);
    ...
    public static void getDoctorByQrId(Context context, String token, String doctorId,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_DOCTOR_BY_QR_ID, listener));
    }
    ...
    public static void addDoctorFriend(Context context, String token, String doctorCode,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(
                        new AbstractLoadViewObserver<>(context, true, false,
                                Tasks.ADD_DOCTOR_FRIEND, listener));
    }
    ...
    public static void getRemoteTime(Context context, String token, String date,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, false, Tasks.GET_REMOTE_TIME,
                        listener));
    }

    public static void getRemoteDepartmentInfo(Context context, String token, String startAt,
                                               String endAt,
                                               final ResponseListener<BaseResponse> listener) {
        Map<String, String> params = new HashMap<>(16);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true,
                        Tasks.GET_REMOTE_DEPARTMENT_INFO,
                        listener));
    }
    ...
    public static void addReserveRemoteOrder(Context context, String token, ReserveRemoteBean bean,
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .compose(RxJavaHelper.observableIO2Main(context))
                .subscribe(new AbstractLoadViewObserver<>(context, true, false,
                        Tasks.ADD_RESERVE_REMOTE_ORDER,
                        listener));
    }

    public static void getReserveRemoteOrderList(Context context, String token, int pageSize,
                                                 int startPage,
                                                 boolean showLoading,
                                                 final ResponseListener<BaseResponse> listener) {
        Map<String, Integer> params = new HashMap<>(16);
        ...
        RetrofitManager.getApiUrlManager()
                ...
                .subscribe(
                        new AbstractLoadViewObserver<>(context, showLoading,
                                Tasks.GET_RESERVE_REMOTE_ORDER_LIST,
                                listener));
    }

    public static void queryPackageList(Context context, String token, int pageSize,
                                        int startPage, boolean showLoading,
                                        final ResponseListener<BaseResponse> listener) {
        Map<String, Integer> params = new HashMap<>(16);
        params.put("pageSize", pageSize);
        params.put("startPage", startPage);
