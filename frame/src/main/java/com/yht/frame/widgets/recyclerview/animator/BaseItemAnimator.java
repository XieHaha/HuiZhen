package com.yht.frame.widgets.recyclerview.animator;
...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    private static class ChangeInfo {
        ...
        private ChangeInfo(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder, int fromX, int fromY,
                int toX, int toY) {
