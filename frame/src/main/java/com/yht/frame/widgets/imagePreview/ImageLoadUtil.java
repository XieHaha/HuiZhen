package com.yht.frame.widgets.imagePreview;
...
public class ImageLoadUtil {
    ...
    public DisplayImageOptions getOptionsForPortrait() {
        return new DisplayImageOptions.Builder().cacheInMemory(true)
                                                .cacheOnDisk(true)
                                                //                .bitmapConfig(Bitmap.Config.RGB_565)
                                                .showImageForEmptyUri(R.mipmap.ic_default_header_r)
                                                .showImageOnFail(R.mipmap.ic_default_header_r)
                                                .showImageOnLoading(R.mipmap.ic_default_header_r)
