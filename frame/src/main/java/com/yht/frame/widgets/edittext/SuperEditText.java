...
public class SuperEditText extends AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        //===================删除图标================
        // 1. 获取资源ID
        int icDeleteResID = typedArray.getResourceId(R.styleable.SuperEditText_ic_delete, R.mipmap.ic_launcher_test);
        // 2. 根据资源ID获取图标资源（转化成Drawable对象）
        ...
        // 原理：通过 反射机制 动态设置光标
        // 1. 获取资源ID
        //        int cursor = typedArray.getResourceId(R.styleable.SuperEditText_cursor, R.mipmap.ic_launcher_test);
        //        try {
        //            // 2. 通过反射 获取光标属性
        ...
        int lineColorClickDefault = ContextCompat.getColor(context, R.color.color_17242e);
        int lineColorNoClickDefault = ContextCompat.getColor(context, R.color.color_17242e);
